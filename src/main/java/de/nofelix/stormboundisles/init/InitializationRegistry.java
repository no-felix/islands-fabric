...
/**
 * Registry for discovering and calling initialization methods annotated with {@link Initialize}.
 * <p>
 ...
 * <p>
 * Methods must be static, have no parameters, and return void to be eligible for automatic
 * initialization.
 */
public class InitializationRegistry {
    ...
    /**
     * Discovers and executes all initialization methods in the given package and its subpackages.
