 ...
 * <p>
 * This class provides commands for moderators to add or remove points from
 * teams,
 * with optional reasons that can be broadcast to all players. These commands
 * are
 * restricted to moderator permission level (2).
 * <p>
 * The commands update both the team's stored point value and the scoreboard
 * display.
 */
public class PointsCommands implements CommandCategory {
        ...
        public void register(LiteralArgumentBuilder<ServerCommandSource> rootCommand) {
                ...
                LiteralArgumentBuilder<ServerCommandSource> pointsCommand = CommandManager.literal("points")
         ...
         * <p>
         * This method validates the team, applies the point change, updates the
         * scoreboard,
         * and provides appropriate feedback. If a reason is provided, the point change
         * is
