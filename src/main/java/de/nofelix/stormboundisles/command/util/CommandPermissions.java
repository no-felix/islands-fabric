 ...
 * <p>
 * This class defines standardized permission levels used throughout the command system
 * and provides utility methods for creating permission predicates that can be used with
...
public class CommandPermissions {
     ...
     * <p>
     * This method returns a predicate that can be used with Brigadier's {@code requires()}
